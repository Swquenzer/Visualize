...
$('.twag-header .twag-toggle').on("click", "img", function() {
    var twagHeader = $('.twag-header h2');
    if(twagHeader[0].innerHTML === 'This Week at a Glance') {
        twagHeader[0].innerHTML = 'Engagement Summary';
    } else {
        twagHeader[0].innerHTML = 'This Week at a Glance';
    }
